...
class CameraExposureDock(AdvancedDockWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.background_subtraction_button = QtWidgets.QPushButton('Background Subtraction: OFF')
        self.background_subtraction_button.setCheckable(True)
        self.background_subtraction_button.setMinimumHeight(35)
        self.background_subtraction_button.clicked[bool].connect(self._on_background_subtraction_toggled)
        ...
        self.integration_spinbox.valueChanged.connect(self._on_integration_spinbox_changed)
        ...
        main_widget.setSizePolicy(QtWidgets.QSizePolicy.Preferred, 
    ...
    def get_integration_value_ns(self):
        ...
        return self.integration_spinbox.value() * 1000
