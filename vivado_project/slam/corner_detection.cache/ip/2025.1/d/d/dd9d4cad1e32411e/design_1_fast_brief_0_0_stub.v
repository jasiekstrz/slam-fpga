...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst_n, num_frames, pixel_valid, pixel_in, 
  hsync_in, vsync_in, vde_in, frame_start, pixel_out, hsync_out, vsync_out, vde_out, m_axis_tdata, 
  m_axis_tvalid, m_axis_tlast, m_axis_tready)
/* synthesis syn_black_box black_box_pad_pin="rst_n,num_frames[7:0],pixel_valid,pixel_in[7:0],hsync_in,vsync_in,vde_in,frame_start,pixel_out[23:0],hsync_out,vsync_out,vde_out,m_axis_tdata[279:0],m_axis_tvalid,m_axis_tlast,m_axis_tready" */
