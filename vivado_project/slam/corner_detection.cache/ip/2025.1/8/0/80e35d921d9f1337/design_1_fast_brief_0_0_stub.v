...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst_n, pixel_valid, pixel_in, hsync_in, 
  vsync_in, vde_in, frame_start, pixel_out, hsync_out, vsync_out, vde_out, m_axis_tdata, 
  m_axis_tvalid, m_axis_tlast, m_axis_tready)
/* synthesis syn_black_box black_box_pad_pin="rst_n,pixel_valid,pixel_in[7:0],hsync_in,vsync_in,vde_in,frame_start,pixel_out[23:0],hsync_out,vsync_out,vde_out,m_axis_tdata[279:0],m_axis_tvalid,m_axis_tlast,m_axis_tready" */
/* synthesis syn_force_seq_prim="clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 rst_n RST" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME rst_n, INSERT_VIP 0" *) input rst_n;
  input pixel_valid;
  input [7:0]pixel_in;
  input hsync_in;
  input vsync_in;
