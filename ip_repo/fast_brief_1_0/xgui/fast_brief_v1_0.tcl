...
proc update_PARAM_VALUE.MAX_CORNERS { PARAM_VALUE.MAX_CORNERS } {
	# Procedure called to update MAX_CORNERS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_CORNERS { PARAM_VALUE.MAX_CORNERS } {
	# Procedure called to validate MAX_CORNERS
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_CORNERS { MODELPARAM_VALUE.MAX_CORNERS PARAM_VALUE.MAX_CORNERS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_CORNERS}] ${MODELPARAM_VALUE.MAX_CORNERS}
}
