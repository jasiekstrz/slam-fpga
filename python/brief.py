...
def test_brief():
    # Load test image
    image1 = Image.open('../../img/image.jpg')
...
#def test_matching():
def test_matching(image1, image2):
    # Load two consecutive frames
    #image1 = Image.open('../../img/frame1.png').convert('L')
    #image2 = Image.open('../../img/frame2.png').convert('L')
    #image1 = Image.open('../../img/rec1/frames/frame_0001.png').convert('L')
    #image2 = Image.open('../../img/rec1/frames/frame_0050.png').convert('L')
    ...
    corners1 = fast_corner_detection(gray1, threshold=10)
    corners2 = fast_corner_detection(gray2, threshold=10)

    corners1 = np.array(adaptive_nms(corners1, np.array(gray1), num_features=2000, min_distance=5))
    corners2 = np.array(adaptive_nms(corners2, np.array(gray2), num_features=2000, min_distance=5))
